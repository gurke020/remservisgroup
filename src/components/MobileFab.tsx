  ...
  return (
    ...
    >
      <a
        ...
        className="flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg hover:scale-110 transition-all active:scale-95"
        aria-label="WhatsApp"
      >
        <svg className="w-[60%] h-[60%]" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
